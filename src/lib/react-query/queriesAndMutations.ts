...
export const useSignOutAccount = () => {
  return useMutation({
    mutationFn: signOutAccount, //we don't need to call signOutAccount() here because useMutation will automatically call it
  });
};

//this useCreatePost is used to create a post
